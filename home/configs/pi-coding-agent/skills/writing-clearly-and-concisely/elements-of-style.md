# The Elements of Style — Condensed for Technical Writing
...
- **Poor:** He was not very often on time.
...
Many expressions commonly used in technical writing are needless:
...
- **Poor:** He noticed a large stain in the rug that was lying in the corner.
- **Better:** In the corner he noticed a large stain in the rug.
...
- **Poor:** This steel is principally used for making razors, because of its hardness.
- **Better:** Because of its hardness, this steel is principally used for making razors.

## Commonly misused words and expressions

- **comprise** — means "include" or "contain." The whole comprises the parts; the parts do not comprise the whole.
- **data** — plural. "The data are convincing."
- **effect / affect** — _effect_ as noun = result; _effect_ as verb = accomplish. _affect_ as verb = influence.
- **etc.** — not to be used for "and the rest" when the reader can supply the omission.
- **less / fewer** — _less_ refers to quantity, _fewer_ to number. "Less than 10 words" → "Fewer than 10 words."
- **literally** — use only for things that actually happened. Not for emphasis.
- **unique** — means "without like or equal." No qualifiers needed. Avoid "very unique."

## AI and corporate jargon

Avoid these in all writing. Use the plain alternative:
